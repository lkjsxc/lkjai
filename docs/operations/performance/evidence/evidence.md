...
Owner: `docs/operations/performance/evidence/evidence.md`.
...
[contract-inventory.md](../../../architecture/native/contracts/contract-inventory.md),
[benchmarking.md](../measurement/benchmarking.md), and the relevant architecture docs.
