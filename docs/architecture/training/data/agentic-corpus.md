...
Active agentic rows are generated from actual repository docs and source files,
then consumed by the native trainer.

The old hand-written JSON agentic source packs were removed. Regenerate
agentic rows from docs and source code instead of reintroducing static packs.

## Links

- [corpus.md](corpus.md): overall dataset contract
- [pipeline.md](../pipeline/pipeline.md): training pipeline order
