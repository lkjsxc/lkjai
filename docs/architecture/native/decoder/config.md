...
- SwiGLU MLP.
- Tied token embeddings and LM head for the first accepted path.
...
| File | Role | Shape |
|---|---|---|
| `decoder_40m_bf16_3070.json` | RTX 3070 product acceptance target | 10 layers, hidden 576, 8 heads, 2 KV heads, FFN 1536, seq 1024, tied embeddings |
