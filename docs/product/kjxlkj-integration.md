...
- Read, search, and history may run directly.
- Create, update, and delete operations must first produce
...
- `resource.get` -> `GET /api/users/{user}/resources/{ref}`
- `resource.history` -> `GET /api/users/{user}/resources/{ref}/history`
- `resource.create` -> `POST /api/users/{user}/resources/notes`
- `resource.update_resource` -> `PUT /api/users/{user}/resources/{ref}`
- `resource.delete` -> `DELETE /api/users/{user}/resources/{ref}`
