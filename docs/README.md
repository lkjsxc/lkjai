...
13. [research/native-decoder-roadmap.md](research/native-decoder-roadmap.md)
14. [architecture/native/transformer-cuda-roadmap.md](architecture/native/transformer-cuda-roadmap.md)
15. [operations/performance/hardware-profiles.md](operations/performance/hardware-profiles.md)
16. [architecture/model/serving.md](architecture/model/serving.md)
17. [product/kjxlkj-integration.md](product/kjxlkj-integration.md)
18. [operations/training/competency-gate.md](operations/training/competency-gate.md)
