...
class CorpusGenerator:
    ...
    def sample_first_workflow(self) -> None:
        ...
        cmd = "`bash scripts/kimi_corpus/launch_background.sh --config configs/corpus/kimi_500m.yaml --target-tokens 500000000 --parallelism 2 --output-dir training/corpus/kimi-synthetic-v1 --full`"
