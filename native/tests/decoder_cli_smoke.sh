...
grep -q '"backward_backend":"cuda_diagnostic_synthetic"' "$report"
...
grep -q '"decoder_backward_backend":"cuda_diagnostic_synthetic"' "$report"
grep -q '"decoder_gradient_source":"cuda_device_diagnostic"' "$report"
