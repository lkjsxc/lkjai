...
def make_settings(preset, model_preset, resolver, vocab, seq, layers, hidden, heads, kv, ffn, steps, rows=20, max_steps=None, batch=None, accumulation=None, seq_override=None):
    ...
    return TrainSettings(
        ...
        intermediate_save_every_optimizer_steps=resolver.int("TRAIN_INTERMEDIATE_SAVE_EVERY_OPTIMIZER_STEPS", "intermediate_save_every_optimizer_steps", 0 if preset == "quick" else 120000),
        ...
        init_checkpoint=resolver.str("TRAIN_INIT_CHECKPOINT", "init_checkpoint", ""),
        ...
        xml_validity_threshold=resolver.float("TRAIN_XML_VALIDITY_THRESHOLD", "xml_validity_threshold", 0.95),
        everyday_chat_threshold=resolver.float("TRAIN_EVERYDAY_CHAT_THRESHOLD", "everyday_chat_threshold", 0.90),
