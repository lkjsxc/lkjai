...
def repo_schema_rows(limit: int) -> list[dict]:
    ...
    for index in range(limit):
        ...
        metadata = meta(row_id, "runtime-schema", kind, "apps/runtime/src/agent/schema.rs", split=split_for(row_id))
        if kind == "tool_call":
