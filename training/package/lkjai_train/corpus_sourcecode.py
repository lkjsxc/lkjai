...
SOURCE_FILES = [
    ...
    "apps/runtime/src/agent/confirmation.rs", "apps/runtime/src/agent/memory.rs", "apps/runtime/src/agent/prompt.rs",
    "apps/runtime/src/config.rs", "apps/runtime/src/lib.rs", "apps/runtime/src/main.rs", "apps/runtime/src/model_client.rs",
    "Cargo.toml", "compose.yaml", "README.md", "ops/verify.sh", ".env.example",
]
