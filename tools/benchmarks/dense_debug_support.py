...
def promotion_summary(
    ...
    return {
        ...
        "cuda_driver_version": report.get("cuda_driver_version", 0),
        "cuda_runtime_version": report.get("cuda_runtime_version", 0),
        "cudnn_version": report.get("cudnn_version", 0),
        "cuda_device_count": report.get("cuda_device_count", 0),
        "cuda_device_index": report.get("cuda_device_index", 0),
        "cuda_total_global_memory": report.get("cuda_total_global_memory", 0),
        "cuda_sm_count": report.get("cuda_sm_count", 0),
